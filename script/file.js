...
const codewars = document.getElementById("cw");
...
cw.addEventListener("click", function () {
    window.open("https://www.codewars.com/users/kris-den-hertog", "_blank");

})
gh.addEventListener("click", function () {
    window.open("https://github.com/kris-den-hertog", "_blank");
